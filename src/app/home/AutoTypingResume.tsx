...
export const AutoTypingResume = () => {
  const [resume, setResume] = useState(structuredClone(initialResumeState));
      ...
      <ResumeIframeCSR documentSize="Letter" scale={isLg ? 0.7 : 0.5}>
        <ResumePDF
          ...
          settings={{
            ...
            fontSize: "12",
            formToHeading: {
              workExperiences: resume.workExperiences[0].jobTitle ? "WORK XP" : "",
              ...
              custom: resume.custom.length > 0 ? "CUSTOM SECTION" : "",
            },
          }}
        />
      </ResumeIframeCSR>
